...
import { ArrowRight, BadgeCheck, CalendarDays, Compass, HelpCircle, LogIn, Search, Wallet, Zap} from "lucide-react";
        ...
        <Container>
          <div className="flex h-16 items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              <Button href={d.header.ctas.secondary.href} variant="secondary" rightIcon={<LogIn className="h-4 w-4" />}>
                {d.header.ctas.secondary.label}
              </Button>
              <Button href={d.header.ctas.primary.href} variant="primary" rightIcon={<ArrowRight className="h-4 w-4" />}>
        ...
        <Container>
          <div className="grid items-center gap-8 lg:grid-cols-12">
            ...
            <div className="lg:col-span-5">
              <div className="relative overflow-hidden rounded-3xl bg-neutral-900 p-6 text-white shadow-sm">
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          {d.paths.cards.map((c) => (
            <Card
              ...
              className={cx(
                "flex flex-col",
                c.highlight ? "ring-2 ring-neutral-900 shadow-md" : ""
              )}
            >
              ...
              <div className="mt-5">
                <Button href={c.cta.href} variant="secondary" rightIcon={<ArrowRight className="h-4 w-4" />}>
                  {c.cta.label}
                </Button>
              </div>
            </Card>
